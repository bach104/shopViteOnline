const OrderItem = ({ order, getProductImage, onViewDetails, statusColors = {} }) => {
  ...
  return (
    <div className="flex shoppingItems shoppingOrders gap-2 h-32 bg__select p-2 rounded-sm mb-3 shadow-sm">
      <nav className="w-28 flex items-center">
        <img 
